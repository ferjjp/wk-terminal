...
ACTIONS: dict[str, tuple[str, str, str]] = {
    ...
    "anki_reveal": ("space", "reviews (Anki mode)", "reveal the answer"),
    "anki_correct": ("1", "reviews (Anki mode)", "I knew it"),
    "anki_incorrect": ("2", "reviews (Anki mode)", "I did not know it"),
    "anki_toggle": ("f3", "reviews", "switch Anki mode on/off for this session"),
