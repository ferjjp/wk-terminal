...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_r = sub.add_parser("read", help="experimental: colour a plain-text Japanese file by what you know and list the kanji/words you don't")
    p_r.add_argument("file", nargs="?", default="-", help="plain-text file to read (default: stdin); no PDF/EPUB/HTML yet")
